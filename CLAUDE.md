...
The gateway Caddyfile is static in the repo — it is **not** regenerated by
`deploy.sh`. New clients start with a minimal Caddyfile (admin + prompt-composer
only), edited manually as services are enabled.
