export default {
  ...
  CONTACT_FORM: {
    ...
    run: (args, canvas) => new Promise(resolve => {
      ...
      const submitBtn = mkBtn('שלח', true)
      const cancelBtn = mkBtn('ביטול', false)
      // RTL: cancel on left visually = first in DOM
      ...
      submitBtn.onclick = () => {
        ...
        close(`המשתמש השאיר פרטים — שם: ${d.first_name} ${d.last_name}, טלפון: ${d.phone}`, false)
      }
      cancelBtn.onclick = () => close('המשתמש ביטל את מילוי הטופס', false)
    })
  },
